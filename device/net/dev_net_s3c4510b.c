...
int
net_s3c4510b_read_word (struct device_desc *dev, uint32 addr, uint32 * data)
{
	struct net_device *net_dev = (struct net_device *) dev->dev;
	struct net_s3c4510b_io *io = (struct net_s3c4510b_io *) dev->data;

	int offset = (uint16) (addr - dev->base + 0x9000);
	int ret = ADDR_HIT;
...
int
net_s3c4510b_write_word (struct device_desc *dev, uint32 addr, uint32 data)
{
	struct net_device *net_dev = (struct net_device *) dev->dev;
	struct net_s3c4510b_io *io = (struct net_s3c4510b_io *) dev->data;
