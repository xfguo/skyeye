 ...
 *       Filename:  i_rdy.c
 *
 *    Description:  Implementst the RDY SPARC instruction
 *
 *        Version:  1.0
...
31-30  29-25   24-19     18-14    13        12-5          4-0
+----+-------+--------+------------------------------------------+
| 10 | 00000 | 101000 |   rs1   | i=0 |   non-used   |    rs2    |
+----+-------+--------+------------------------------------------+
...
#define RDY_CYCLES    1
#define RDY_CODE_MASK 0x81400000
#define PRIVILEDGE  0
...
static int disassemble(uint32 instr, void *state)
{
    ...
    if( (instr & RDY_CODE_MASK) && (op == OP) && (op3 == OP3) )
    {
