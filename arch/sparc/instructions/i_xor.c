 ...
 *       Filename:  i_xor.c
 *
 *    Description:  Implementation of the SPARC XOR instruction
 *
 *        Version:  1.0
...
31-30  29-25   24-19     18-14    13        12-5          4-0
+----+-------+--------+------------------------------------------+
| 10 | 00000 | 000011 |   rs1   | i=0 |   non-used   |    rs2    |
+----+-------+--------+------------------------------------------+
...
#define XOR_CYCLES    1
#define XOR_CODE_MASK 0x80180000
#define PRIVILEDGE  0
...
static int disassemble(uint32 instr, void *state)
{
    ...
    if( (instr & XOR_CODE_MASK) && (op == OP) && (op3 == OP3) )
    {
