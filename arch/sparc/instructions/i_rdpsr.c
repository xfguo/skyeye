...
31-30  29-25   24-19     18-14    13        12-5          4-0
+----+-------+--------+------------------------------------------+
| 10 | 00000 | 101001 |   rs1   | i=0 |   non-used   |    rs2    |
+----+-------+--------+------------------------------------------+
...
#define RDPSR_CYCLES    1
#define RDPSR_CODE_MASK 0x81480000
#define PRIVILEDGE  1
...
static int disassemble(uint32 instr, void *state)
{
    ...
    if( (instr & RDPSR_CODE_MASK) && (op == OP) )
    {
