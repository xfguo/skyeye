...
//	CR_REGNUM = (PPC_GPR_SIZE + PPC_FPR_SIZE),
	...
	PHYSICAL_CODE_PAGE_REGNUM,	/* FIXME it is a pointer and not portable on 64bit machine ? */
	PDEC_REGNUM,				/* FIXME if on 64bit machine, PDEC_REGNUM = PHYSICAL_CODE_PAGE_REGNUM + 2 ? */
