...
#define	SIU_INT_ERROR		((uint32)0x00+CPM_IRQ_OFFSET)
#define	SIU_INT_I2C		((uint32)0x01+CPM_IRQ_OFFSET)
#define	SIU_INT_SPI		((uint32)0x02+CPM_IRQ_OFFSET)
#define	SIU_INT_RISC		((uint32)0x03+CPM_IRQ_OFFSET)
#define	SIU_INT_SMC1		((uint32)0x04+CPM_IRQ_OFFSET)
#define	SIU_INT_SMC2		((uint32)0x05+CPM_IRQ_OFFSET)
#define	SIU_INT_USB		((uint32)0x0b+CPM_IRQ_OFFSET)
#define	SIU_INT_TIMER1		((uint32)0x0c+CPM_IRQ_OFFSET)
#define	SIU_INT_TIMER2		((uint32)0x0d+CPM_IRQ_OFFSET)
#define	SIU_INT_TIMER3		((uint32)0x0e+CPM_IRQ_OFFSET)
#define	SIU_INT_TIMER4		((uint32)0x0f+CPM_IRQ_OFFSET)
#define	SIU_INT_FCC1		((uint32)0x20+CPM_IRQ_OFFSET)
#define	SIU_INT_FCC2		((uint32)0x21+CPM_IRQ_OFFSET)
#define	SIU_INT_FCC3		((uint32)0x22+CPM_IRQ_OFFSET)
#define	SIU_INT_MCC1		((uint32)0x24+CPM_IRQ_OFFSET)
#define	SIU_INT_MCC2		((uint32)0x25+CPM_IRQ_OFFSET)
#define	SIU_INT_SCC1		((uint32)0x28+CPM_IRQ_OFFSET)
#define	SIU_INT_SCC2		((uint32)0x29+CPM_IRQ_OFFSET)
#define	SIU_INT_SCC3		((uint32)0x2a+CPM_IRQ_OFFSET)
#define	SIU_INT_SCC4		((uint32)0x2b+CPM_IRQ_OFFSET)
#define	SIU_INT_PC15		((uint32)0x30+CPM_IRQ_OFFSET)
#define	SIU_INT_PC14		((uint32)0x31+CPM_IRQ_OFFSET)
#define	SIU_INT_PC13		((uint32)0x32+CPM_IRQ_OFFSET)
#define	SIU_INT_PC12		((uint32)0x33+CPM_IRQ_OFFSET)
#define	SIU_INT_PC11		((uint32)0x34+CPM_IRQ_OFFSET)
#define	SIU_INT_PC10		((uint32)0x35+CPM_IRQ_OFFSET)
#define	SIU_INT_PC9		((uint32)0x36+CPM_IRQ_OFFSET)
#define	SIU_INT_PC8		((uint32)0x37+CPM_IRQ_OFFSET)
#define	SIU_INT_PC7		((uint32)0x38+CPM_IRQ_OFFSET)
#define	SIU_INT_PC6		((uint32)0x39+CPM_IRQ_OFFSET)
#define	SIU_INT_PC5		((uint32)0x3a+CPM_IRQ_OFFSET)
#define	SIU_INT_PC4		((uint32)0x3b+CPM_IRQ_OFFSET)
#define	SIU_INT_PC3		((uint32)0x3c+CPM_IRQ_OFFSET)
#define	SIU_INT_PC2		((uint32)0x3d+CPM_IRQ_OFFSET)
#define	SIU_INT_PC1		((uint32)0x3e+CPM_IRQ_OFFSET)
#define	SIU_INT_PC0		((uint32)0x3f+CPM_IRQ_OFFSET)
