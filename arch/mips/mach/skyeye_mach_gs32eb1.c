...
static void gs32eb1_boot_linux(generic_arch_t* arch_instance){
...
static void
gs32eb1_io_reset(machine_config_t *mach)
{
	void gs32eb1_boot_linux();
	 register_callback(gs32eb1_boot_linux, Bootmach_callback);
}
...
gs32eb1_mach_init (void * arch_instance, machine_config_t * this_mach)
{
	...
	this_mach->mach_io_reset = gs32eb1_io_reset;
