...
static void au1100_boot_linux(generic_arch_t* arch_instance){
...
static void
au1100_io_reset(machine_config_t *mach)
{
	void au1100_boot_linux();
        register_callback(au1100_boot_linux, Bootmach_callback);
...
au1100_mach_init (void * arch_instance, machine_config_t * this_mach)
{
	...
	this_mach->mach_io_reset = au1100_io_reset;
}
