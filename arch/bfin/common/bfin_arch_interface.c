/*
        bfin_arch_interface.c - necessary arch definition for skyeye debugger
...
bfin_init_state ()
{
	...
	/*mach init */
	printf("The below code not finished porting.\n");
...
init_bfin_arch ()
{
	...
	//bfin_arch.get_regval_by_id = bfin_get_regval_by_id;
        //bfin_arch.get_regname_by_id = bfin_get_regname_by_id;
        //bfin_arch.get_step = bfin_get_step;
