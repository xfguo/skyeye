...
/* 
 * FIXME, copy from iberty library, we can not link the dynamic 
 * version of iberty. Michae.Kang
 */
#if 1 /* add the following defination to avoid compilation error. Need to be fixed later */
