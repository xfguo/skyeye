...
typedef struct lh79520_io
{
	...
	uint32_t tcd_ctrl[2];	/* Timer Control Register */
	int tc_prescale;
	...
	uint32_t uartmis;	/* Masked Interrupt Status Register */
} lh79520_io_t;
...
//	state->Reg[1] = 997;	//MACH_TYPE_LH79520LPD
	((generic_arch_t *)state)->set_regval_by_id(1, 997); /* MACH_TYPE_LH79520LPD */
...
#if 0
	state->mach_io.instr = (uint32_t *) & io.intsr;
#endif
}
