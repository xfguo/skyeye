...
static void
omap5912_update_l2_int (void *state)
{
	uint32_t requests;
	int i;
...
void
omap5912_io_write_byte (void *state, uint32_t addr, uint32_t data)
{
...
void
omap5912_io_write_halfword (void *state, uint32_t addr, uint32_t data)
{
...
uint32_t
omap5912_io_read_byte (void *state, uint32_t addr)
{
...
uint32_t
omap5912_io_read_halfword (void *state, uint32_t addr)
{
...
#endif
	((generic_arch_t *)state)->set_regval_by_id(1, 515); /*mainstone machine id. */
	omap5912_io_reset ();
