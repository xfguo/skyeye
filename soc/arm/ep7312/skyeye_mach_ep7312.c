...
typedef struct ep7312_io
{
	...
	//ywc,2004-04-01
	uint32_t ts_int;		/* ywc 2004-04-02 */
	uint32_t ts_buffer[8];
	//uint32_t               tsaddr;                 /* ??? touch srceen data buffer start address*/
...
void
ep7312_mach_init (void *arch_instance, machine_config_t *this_mach)
{
#if 0
	state->abort_model = 2;
	...
	((generic_arch_t *)arch_instance)->set_regval_by_id(1, 91); /* for EP7212/EP7312 arch id */
