...
sa_io_reset ()
{
 ...
 /*TNF*/};
void
sa_io_write_byte (void  *state, uint32_t addr, uint32_t data)
{
...
void
sa_io_write_halfword (void  *state, uint32_t addr, uint32_t data)
{
...
static void
sa_io_write_word (void *state, uint32_t addr, uint32_t data)
{
	switch (addr) {
	 /*RTC*/ case RCNR:
		sa_io.rcnr = data;
...
uint32_t
sa_io_read_byte (void  *state, uint32_t addr)
{
...
uint32_t
sa_io_read_halfword (void  *state, uint32_t addr)
{
...
uint32_t
sa_io_read_word (void  *state, uint32_t addr)
{
	u32 data;
...
/*	state->Reg[1] = 109;*/	/*adsbitsy machine id. */
	((generic_arch_t *)arch_instance)->set_regval_by_id(1, 109); /*adsbitsy machine id. */
	sa_io_reset ();
