...
static void
at91rm92_update_int (void *arch_instance)
{
	u32 requests = io.ipr & io.imr;
#if 0
	...
	interrupt_signal.arm_signal.irq = (requests & 0xfffffffe) ? Low_level : High_level;
...
static void
at91rm92_io_reset (generic_arch_t *arch_instance)
{
	int i = 0;
	for(;i < UART_NUM; i++){
...
static void
at91rm92_uart_write (generic_arch_t *state, u32 offset, u32 data)
{
...
static u32
at91rm92_io_read_word (void *arch_instance, u32 addr)
{
...
static void
at91rm92_io_write_word (generic_arch_t *state, u32 addr, u32 data)
{
	if ((addr >= AT91RM92_UART_BASE) &&
	    (addr < AT91RM92_UART_BASE + UART_NUM * AT91RM92_UART_SIZE)) {
...
static void
at91rm92_io_write_byte (generic_arch_t *state, u32 addr, u32 data)
{
...
static void
at91rm92_io_write_halfword (generic_arch_t *state, u32 addr, u32 data)
{
...
at91rm92_mach_init (generic_arch_t *arch_instance, machine_config_t *this_mach)
{
	...
	arch_instance->set_regval_by_id(1, 251);	/* for AT91RM9200 */
	arch_instance->set_regval_by_id(1, 262);        /* for AT91RM9200DK */
/*	arch_instance->set_regval_by_id(1, 705); */	/* AT91RM9200EK */
	...
	at91rm92_io_reset(arch_instance);
