/*
	ns9750.h - definitions of "ns975000" machine  for skyeye
 ...
 * ns975000 use "USART" instead of "UART". we here use name "UART".
 * */

#define AT91RM92_UART_BASE0       (0xfffc0000)
#define AT91RM92_UART_BASE1       (0xfffc4000)
