...
static void
s3c2440_uart_write (void *state, u32 offset, u32 data)
{
...
static void
s3c2440_io_write_word (void *state, uint32_t addr, uint32_t data)
{
	if ((addr >= UART_CTL_BASE0)
	    && (addr < UART_CTL_BASE0 + UART_CTL_SIZE)) {
...
static void
s3c2440_io_write_byte (void  *state, uint32_t addr, uint32_t data)
{
...
static void
s3c2440_io_write_halfword (void  *state, uint32_t addr, uint32_t data)
{
